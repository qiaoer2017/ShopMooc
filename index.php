    ...
    <div class="shopList comWidth clearfix">
        ...
        <div class="rightArea">
            <div class="shopList_top clearfix">
                <?php $pros = getProsByCid($link, $cate['id']);
                if ($pros && is_array($pros)):
                    foreach ($pros as $pro):
                        ...
                        <div class="shop_item">
                            <div class="shop_img">
                                <a href="proDetails.php?id=<?=$pro['id']?>" target="_blank"><img height="187" width="200"
                                                                              src="image_220/<?= $proImg['albumPath'] ?>"
                                                                              alt=""></a>
                            </div>
                            <h6><?= $pro['pName'] ?></h6>
                            <p><?= $pro['iPrice'] ?>元</p>
            ...
            <div class="shopList_sm clearfix">
                <?php $prosSmall = getSmallProsByCid($link, $cate['id']);
                    ...
                    foreach ($prosSmall as $proSmall):
                        ...
                        <div class="shopItem_sm">
                            <div class="shopItem_smImg">
                                <a href="proDetails.php?id=<?=$proSmall['id']?>" target="_blank"><img width="95" height="95"
                                                                              src="image_220/<?= $proSmallImg['albumPath'] ?>"
                                                                              alt=""></a>
                            </div>
                            <div class="shopItem_text">
                                <p><?= $proSmall['pName'] ?></p>
                                <h6>￥<?= $proSmall['iPrice'] ?> </h6>
                            </div>
                        </div>
                        <?php
                    endforeach;
